              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    ...
                    //   ),
                    // ),
                    Expanded(child: IconButton(onPressed: (){}, icon: Icon(Icons.ac_unit))),
                    Expanded(child: IconButton(onPressed: (){}, icon: Icon(Icons.access_alarm))),
                    Expanded(child: IconButton(onPressed: (){}, icon: Icon(Icons.offline_bolt_outlined))),
                    Expanded(child: IconButton(onPressed: (){}, icon: Icon(Icons.battery_alert))),
                  ]),
                ),
              )
            ],
