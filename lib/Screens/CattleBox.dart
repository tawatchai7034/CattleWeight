...
class _MenuOptionState extends State<MenuOption> {
  ...
  Widget build(BuildContext context) {
    return PopupMenuButton<int>(
        ...
        itemBuilder: (context) =>
            [PopupMenuItem<int>(value: 0, child: ListTile(leading: Icon(Icons.delete),title: Text("Delete"),)),
            PopupMenuItem<int>(value: 1, child: ListTile(leading: Icon(Icons.edit),title: Text("Edit"),))]);
  }
}
  ...
  switch (item) {
    case 0:
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context)=> DeleteOption()));
      break;
    case 1:
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context)=> EditOption()));
      break;
  }
}
